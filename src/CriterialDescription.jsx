...
const CriteriaDescription = ({ formData }) => {
    const generateCriteriaDescription = (formData) => {
        ...
        // }
        if (formData.type === "BOND_TYPE_REPLACED") {
            descriptions.push(`✅ Замещающие`)
        }
        if (formData.nominalCurrency === "usd") {
            descriptions.push(`✅ Валюта: 💵`)
        }
        else if (formData.nominalCurrency === "cny") {
            descriptions.push(`✅ Валюта: 💴`)
        }
